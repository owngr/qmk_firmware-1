...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_TAB,       EG_Q,           EG_C,           EG_O,            EG_P,           EG_W,           XXXXXXX,                                        XXXXXXX,         EG_J,           EG_M,           EG_D,           EG_DK,          EG_Y,          KC_BSPC,
    KC_ESC,       EG_A,           EG_S,           EG_E,            EG_N,           EG_F,           XXXXXXX,                                        XXXXXXX,         EG_L,           EG_R,           EG_T,           EG_I,           EG_U,          KC_ENTER,
    KC_LSFT,      EG_Z,           EG_X,           EG_QUES,         EG_V,           EG_B,                                                                            EG_DOT,         EG_H,           EG_G,           EG_COMM,        LT(3,EG_K),    KC_RSFT,
    XXXXXXX,      XXXXXXX,        XXXXXXX,        XXXXXXX,         XXXXXXX,        KC_LGUI,                                                                         TT(1),          XXXXXXX,        XXXXXXX,        XXXXXXX,        XXXXXXX,       XXXXXXX,
                                                  KC_LCTL,         KC_LALT,        XXXXXXX,                                                                         XXXXXXX,        KC_RALT,        KC_SPACE
  ),
  [1] = LAYOUT(
    _______,      _______,        _______,        _______,        _______,         _______,        _______,                                        _______,        _______,        _______,        _______,        _______,        _______,        _______,
    _______,      KC_PSCR,        KC_HOME,        KC_UP,          KC_END,          KC_PGUP,        _______,                                        _______,        KC_KP_SLASH,    KC_KP_7,        KC_KP_8,        KC_KP_9,        _______,        _______,
    _______,      KC_CAPS,        KC_LEFT,        KC_DOWN,        KC_RIGHT,        KC_PGDN,        _______,                                        _______,        KC_KP_MINUS,    KC_KP_4,        KC_KP_5,        KC_KP_6,        KC_KP_0,        _______,
    _______,      _______,        KC_AUDIO_VOL_DOWN,KC_F13,       KC_AUDIO_VOL_UP, KC_DEL,                                                                         KC_KP_COMMA,    KC_KP_1,        KC_KP_2,        KC_KP_3,        KC_KP_DOT,      _______,
